...
function cpc_admin_getting_started_media() {
    ...
    echo '<div class="'.$css.'cpc_admin_getting_started_menu_item" rel="cpc_admin_getting_started_media" id="cpc_admin_getting_started_media_div">'.__('Medien', 'cp-community').'</div>';
    ...
    echo '<div class="cpc_media_admin_tab active" data-tab="general" >'.esc_html__('Allgemein', 'cp-community').'</div>';
    echo '<div class="cpc_media_admin_tab" data-tab="display">'.esc_html__('Anzeige', 'cp-community').'</div>';
    echo '<div class="cpc_media_admin_tab" data-tab="upload">'.esc_html__('Upload', 'cp-community').'</div>';
    echo '<div class="cpc_media_admin_tab" data-tab="lightbox">'.esc_html__('Lightbox', 'cp-community').'</div>';
    echo '<div class="cpc_media_admin_tab" data-tab="privacy">'.esc_html__('Datenschutz', 'cp-community').'</div>';
    echo '</div>';
    ...
    echo '<td scope="row" valign="top"><label>'.__('Benutzer können Galerien erstellen', 'cp-community').'</label></td>';
    ...
    echo '<span class="description">'.__('Erlaubt Benutzern, neue Galerien auf ihrem Profil zu erstellen.', 'cp-community').'</span></td>';
    echo '</tr>';

    echo '<tr class="form-field">';
    echo '<td scope="row" valign="top"><label>'.__('Max. Galerien pro Benutzer', 'cp-community').'</label></td>';
    ...
    echo '<span class="description">'.__('0 = unbegrenzt', 'cp-community').'</span></td>';
    echo '</tr>';
    ...
    echo '<tr class="form-field">';
    echo '<td scope="row" valign="top"><label>'.__('Standard-Layout', 'cp-community').'</label></td>';
    echo '<td><select name="cpc_media_gallery_layout" style="min-width:200px;">';
    echo '<option value="grid"'.selected(cpc_media_get_gallery_layout(), 'grid', false).'>'.__('3er-Grid (empfohlen)', 'cp-community').'</option>';
    echo '<option value="list"'.selected(cpc_media_get_gallery_layout(), 'list', false).'>'.__('Liste', 'cp-community').'</option>';
    echo '</select> <span class="description">'.__('Wie Medien innerhalb einer Galerie angezeigt werden.', 'cp-community').'</span></td>';
    echo '</tr>';

    echo '<tr class="form-field">';
    echo '<td scope="row" valign="top"><label>'.__('Spalten im Grid', 'cp-community').'</label></td>';
    ...
    echo '<span class="description">'.__('Wie viele Items pro Reihe (1-6)', 'cp-community').'</span></td>';
    echo '</tr>';

    echo '<tr class="form-field">';
    echo '<td scope="row" valign="top"><label>'.__('Medien pro Seite anzeigen', 'cp-community').'</label></td>';
    ...
    echo '<span class="description">'.__('Im Profil/Gruppen-Tab', 'cp-community').'</span></td>';
    echo '</tr>';

    echo '<tr class="form-field">';
    echo '<td scope="row" valign="top"><label>'.__('Mediathek-Seite', 'cp-community').'</label></td>';
    echo '<td>';
    ...
    echo '<span class="description">'.__('Optional: diese WordPress-Seite zeigt automatisch die globale Mediathek mit Galerie- und Medienverzeichnis.', 'cp-community').'</span></td>';
    echo '</tr>';

    echo '<tr class="form-field">';
    echo '<td scope="row" valign="top"><label>'.__('Elemente pro Seite in Mediathek', 'cp-community').'</label></td>';
    ...
    echo '<span class="description">'.__('Für globale Galerie- und Medienübersicht.', 'cp-community').'</span></td>';
    echo '</tr>';

    echo '<tr class="form-field">';
    echo '<td scope="row" valign="top"><label>'.__('Galerie-Beschreibungen anzeigen', 'cp-community').'</label></td>';
    ...
    echo '<span class="description">'.__('Zeigt Galerie-Beschreibungen in Karten.', 'cp-community').'</span></td>';
    echo '</tr>';

    echo '<tr class="form-field">';
    echo '<td scope="row" valign="top"><label>'.__('Media-Item Beschreibungen anzeigen', 'cp-community').'</label></td>';
    ...
    echo '<span class="description">'.__('Zeigt Beschreibungen unter jedem Media-Item.', 'cp-community').'</span></td>';
    echo '</tr>';
    ...
    echo '<tr class="form-field">';
    echo '<td scope="row" valign="top"><label>'.__('Max. Dateigröße (MB)', 'cp-community').'</label></td>';
    ...
    echo '<span class="description">'.__('Maximale Größe pro Upload (1-500 MB)', 'cp-community').'</span></td>';
    echo '</tr>';

    echo '<tr class="form-field">';
    echo '<td scope="row" valign="top"><label>'.__('Wall-Medien automatisch spiegeln', 'cp-community').'</label></td>';
    ...
    echo '<span class="description">'.__('Bilder aus Activity+ landen zusätzlich in einer versteckten privaten System-Galerie pro Profil bzw. Gruppe.', 'cp-community').'</span></td>';
    echo '</tr>';
    ...
    echo '<tr class="form-field">';
    echo '<td scope="row" valign="top"><label>'.__('Nutzer-Speicherlimit (MB)', 'cp-community').'</label></td>';
    ...
    echo '<span class="description">'.__('0 = vorhandenes Activity+/Cloud-Limit weiterverwenden, sonst gemeinsames Limit für Galerie- und Activity-Dateien.', 'cp-community').'</span>';
    ...
    echo '<tr class="form-field">';
    echo '<td scope="row" valign="top"><label>'.__('Gruppen-Speicherlimit (MB)', 'cp-community').'</label></td>';
    ...
    echo '<span class="description">'.__('0 = vorhandenes Gruppen-Cloud-Limit weiterverwenden, sonst gemeinsames Limit für Gruppen-Galerien und Gruppen-Activity.', 'cp-community').'</span></td>';
    echo '</tr>';

    echo '<tr class="form-field">';
    echo '<td scope="row" valign="top"><label>'.__('Erlaubte Dateitypen', 'cp-community').'</label></td>';
    echo '<td>';
    $allowed_types = get_option('cpc_media_allowed_types', array('image', 'video', 'audio', 'document'));
    echo '<label><input type="checkbox" name="cpc_media_allowed_types[]" value="image" '.(in_array('image', $allowed_types) ? 'CHECKED' : '').' /> '.__('Bilder (JPG, PNG, GIF)', 'cp-community').'</label><br/>';
    echo '<label><input type="checkbox" name="cpc_media_allowed_types[]" value="video" '.(in_array('video', $allowed_types) ? 'CHECKED' : '').' /> '.__('Videos (MP4, WebM)', 'cp-community').'</label><br/>';
    echo '<label><input type="checkbox" name="cpc_media_allowed_types[]" value="audio" '.(in_array('audio', $allowed_types) ? 'CHECKED' : '').' /> '.__('Audio (MP3, WAV)', 'cp-community').'</label><br/>';
    echo '<label><input type="checkbox" name="cpc_media_allowed_types[]" value="document" '.(in_array('document', $allowed_types) ? 'CHECKED' : '').' /> '.__('Dokumente (PDF, ZIP)', 'cp-community').'</label>';
    echo '<span class="description">'.__('Welche Dateitypen dürfen hochgeladen werden?', 'cp-community').'</span></td>';
    echo '</tr>';

    echo '<tr class="form-field">';
    echo '<td scope="row" valign="top"><label>'.__('Thumbnail-Qualität', 'cp-community').'</label></td>';
    ...
    echo '<span class="description">'.__('Qualität der erzeugten Thumbnails (40-100%)', 'cp-community').'</span></td>';
    echo '</tr>';
    ...
    echo '<tr class="form-field">';
    echo '<td scope="row" valign="top"><label>'.__('Lightbox aktivieren', 'cp-community').'</label></td>';
    ...
    echo '<span class="description">'.__('Modal-Fullscreen-Anzeige beim Klicken auf Bilder/Videos', 'cp-community').'</span></td>';
    echo '</tr>';

    echo '<tr class="form-field">';
    echo '<td scope="row" valign="top"><label>'.__('Lightbox-Auto-Play', 'cp-community').'</label></td>';
    ...
    echo '<span class="description">'.__('Videos automatisch abspielen', 'cp-community').'</span></td>';
    echo '</tr>';

    echo '<tr class="form-field">';
    echo '<td scope="row" valign="top"><label>'.__('Lightbox-Loop', 'cp-community').'</label></td>';
    ...
    echo '<span class="description">'.__('Nach dem letzten Item zum ersten zurückspringen', 'cp-community').'</span></td>';
    echo '</tr>';

    echo '<tr class="form-field">';
    echo '<td scope="row" valign="top"><label>'.__('PDF-Viewer-Modus', 'cp-community').'</label></td>';
    ...
    echo '<option value="native"'.selected($pdf_mode, 'native', false).'>'.esc_html__('Nativ (Browser)', 'cp-community').'</option>';
    echo '<option value="auto"'.selected($pdf_mode, 'auto', false).'>'.esc_html__('Auto (PDF.js bei Bedarf)', 'cp-community').'</option>';
    echo '<option value="pdfjs"'.selected($pdf_mode, 'pdfjs', false).'>'.esc_html__('Immer PDF.js', 'cp-community').'</option>';
    echo '</select>';
    echo '<span class="description">'.__('Verwendet lokalen PDF.js-Fallback ohne CDN fuer Browser mit schwaecherer PDF-Unterstuetzung.', 'cp-community').'</span></td>';
    echo '</tr>';

    echo '<tr class="form-field">';
    echo '<td scope="row" valign="top"><label>'.__('Reorder-Funktion aktivieren', 'cp-community').'</label></td>';
    ...
    echo '<span class="description">'.__('Drag-and-Drop zur Umordnung der Medien', 'cp-community').'</span></td>';
    echo '</tr>';

    echo '<tr class="form-field">';
    echo '<td scope="row" valign="top"><label>'.__('Cover-Auswahl aktivieren', 'cp-community').'</label></td>';
    ...
    echo '<span class="description">'.__('Besitzer können Vorschau-Bild wählen', 'cp-community').'</span></td>';
    echo '</tr>';
    ...
    echo '<tr class="form-field">';
    echo '<td scope="row" valign="top"><label>'.__('Freundes-Sichtbarkeit', 'cp-community').'</label></td>';
    ...
    echo '<span class="description">'.__('Option "Nur Freunde" für Profil-Galerien (benötigt Freundschafts-Modul)', 'cp-community').'</span></td>';
    echo '</tr>';

    echo '<tr class="form-field">';
    echo '<td scope="row" valign="top"><label>'.__('Standardstatus Profil-Galerien', 'cp-community').'</label></td>';
    ...
    echo '<tr class="form-field">';
    echo '<td scope="row" valign="top"><label>'.__('Standardstatus Gruppen-Galerien', 'cp-community').'</label></td>';

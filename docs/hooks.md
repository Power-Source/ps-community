...
**Beschreibung**: Wird ausgelöst, nachdem ein neuer ClassicPress-Beitrag des Typs `cpc_activity` eingefügt wurde. 
...
| `$new_id`    | int    | Die ID des neu erstellten ClassicPress-Beitrags.                               |
